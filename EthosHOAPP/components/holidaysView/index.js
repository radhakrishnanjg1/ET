...
function fun_db_APP_Get_Permited_Holiday_Master(LoginID) {
    var datasource = new kendo.data.DataSource({
        transport: {
            read: {
                url: "https://api.everlive.com/v1/wl2tdph1kbl8l9w8/Invoke/SqlProcedures/APP_Get_Permited_Holiday_Master",
                type: "POST",
                dataType: "json",
                data: {
                    "LoginID": LoginID
